...
func jvmset(e *model.JvmMetrics, jvmDataMap map[string]interface{}) {
	...
	e.GcCountParNew.Set(jvmDataMap["GcCountParNew"].(float64))
	e.GcTimeMillisParNew.Set(jvmDataMap["GcTimeMillisParNew"].(float64))
	e.GcCountConcurrentMarkSweep.Set(jvmDataMap["GcCountConcurrentMarkSweep"].(float64))
	e.GcTimeMillisConcurrentMarkSweep.Set(jvmDataMap["GcTimeMillisConcurrentMarkSweep"].(float64))
